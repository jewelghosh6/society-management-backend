...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('role_has_permissions', [
      ...
      { role_id: await getRoleIdByRoleName('SUPER-ADMIN'), permission_id: await getPermissionIdByPermissionName('can_view_all_flats') },
      { role_id: await getRoleIdByRoleName('SUPER-ADMIN'), permission_id: await getPermissionIdByPermissionName('can_allot_new_flats') },
      ...
      { role_id: await getRoleIdByRoleName('ADMIN'), permission_id: await getPermissionIdByPermissionName('can_allot_new_flats') },
      { role_id: await getRoleIdByRoleName('ADMIN'), permission_id: await getPermissionIdByPermissionName('can_view_all_flats') },
      ...
      { role_id: await getRoleIdByRoleName('SOCIETY MANAGER/PRESIDENT'), permission_id: await getPermissionIdByPermissionName('can_view_all_flats') },
