...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('user_has_permissions', [
      ...
      { user_id: await getUserIdByUserEmail("jewel@gmail.com"), permission_id: await getPermissionIdByPermissionName('can_view_all_flats') },
      { user_id: await getUserIdByUserEmail("jewel@gmail.com"), permission_id: await getPermissionIdByPermissionName('can_allot_new_flats') },
